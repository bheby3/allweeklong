...
To use this to filter data takes only one more step. Inside of the friend list `ng-repeat` 
...
Now that we have our `ng-disabled` working, we just need to flip the value of `editing` anytime 
